...
export const AdvancedSettings: React.FC<AdvancedSettingsProps> = ({
  ...
  return (
    <div className="fixed right-0 top-14 w-64 h-calc[100vh-56px] p-4 bg-white dark:bg-chat-dark border-r-4 border-gray-200 dark:border-gray-500 space-y-4 z-10">
